...
test_that("API key doesn't accept wrong values", {
  expect_error(
    pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = "desktop", key = ""),
    regexp = "API key is a NULL or has length = 0. Please check it and provide a proper API key.")

  expect_error(
    pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = "desktop", key = NULL),
    regexp = "argument is of length zero")
})

test_that("strategy param doesn't accept bad values", {
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = NA))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = ""))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = c("desktop", "mobile")))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = "loremipsum"))
})

test_that("categories param doesn't accept bad values", {
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", categories = ""))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", categories = NA))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", categories = "loremipsum"))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", categories = 1))
})

test_that("interval param doesn't accept bad values", {
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = "desktop", interval = -1))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = "mobile", interval = -1))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = "desktop", interval = 121))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = "mobile", interval = 121))
})

test_that("locale param doesn't accept bad values", {
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = "desktop", locale = ""))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = "mobile", locale = NA))
  expect_error(pagespeedParseR:::lh_simple_1("https://www.google.com", strategy = "mobile", locale = 1))
})
